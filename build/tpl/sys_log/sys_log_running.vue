<template>
  <!-- 用户登录日志查询 -->
  <div class="page-sys_log_running">
    <div class="app-page-container">
          ...
          <el-form :inline="true" :model="searchForm">
            <el-form-item label="分子公司">
              <el-select v-model="searchForm.company_id" clearable placeholder="请选择">
                <el-option v-for="item in constituentCompanyList" :key="item.value" :label="item.label"
                           :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="时间范围">
              <el-date-picker clearable :picker-options="pickerOptions" v-model="searchForm.create_time"
      ...
      <!-- 列表 -->
      <div class="app-page-box">
        <el-table stripe border tooltip-effect="dark" ref="tableData" v-loading="loading" :data="tableData"
          ...
          <el-table-column prop="create_time" label="记录时间" width="150px" sortable="custom">
        ...
        <div class="app-pagination">
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange"
                         :current-page="currentPage" :total="total" :page-sizes="pageSizes" :page-size="pageSize"
  ...
  export default {
    ...
    methods: {
      ...
      search() {
        ...
        let date = this.searchForm.create_time
        if (date && date.length > 0) {
          this.where.push(`create_time=${date[0]}~${date[1]}`)
        }
        this.list();
      },
      // 修改分页数量
...
<style>
  .page-sys_log_running {
  }

  .page-sys_log_running .el-form-item--mini.el-form-item,
  .page-sys_log_running .el-form-item--small.el-form-item {
    margin-bottom: 0px;
  }
</style>
